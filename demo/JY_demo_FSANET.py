...
def draw_axis(img, yaw, pitch, roll, tdx=None, tdy=None, size = 80):
    ...
    cv2.putText(img, str(pitch_show)  ,(0, 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
    cv2.putText(img, str(yaw_show) , (0, 30), cv2.FONT_HERSHEY_SIMPLEX,  0.5, (0, 255, 0), 1)
    cv2.putText(img, str(roll_show) , (0, 50), cv2.FONT_HERSHEY_SIMPLEX , 0.5, (0, 255, 0),1)
